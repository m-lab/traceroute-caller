...
`
	tracelb, err := parser.ExtractTraceLB([]byte(testStr))
	if err != nil {
...
func ParseJSON(fn string, data []byte) ([]string, error) {
...
{"type":"cycle-extra"}
`
	_, err := ParseJSON("20190825T000138Z_ndt-plh7v_1566050090_000000000004D64D.jsonl", []byte(testStr))
...
`
	...
	hop1 := "2001:550:3::1ca"
	output, err := ParseJSON("20190825T000138Z_ndt-plh7v_1566050090_000000000004D64D.jsonl", []byte(testStr))
...
//  BenchmarkHopParsing-4   	    4812	    240118 ns/op	   38880 B/op	     363 allocs/op
...
`)
	...
	for i := 0; i < b.N; i++ {
		hops, err := ParseJSON("20190825T000138Z_ndt-plh7v_1566050090_000000000004D64D.jsonl", data)
